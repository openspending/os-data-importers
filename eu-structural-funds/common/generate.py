                    ...
                    },
                    {
                        ...
                        'parameters': {
                            ...
                            'os-types': {
                                ...
                                'cci_program_code': 'administrative-classification:generic:level3:code',
                                ...
                                'fund_acronym': 'fin-source:generic:level2:code',
                                'funding_period': 'fin-source:generic:level1:code',
                                'management_authority': 'fin-source:generic:level3:code',
                                'member_state_amount': 'value',
                                'operational_programme': 'administrative-classification:generic:level4:code',
                                'priority_label': 'administrative-classification:generic:level2:label',
                                'priority_number': 'administrative-classification:generic:level2:code',
